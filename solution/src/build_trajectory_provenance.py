...
def tokenize_event_lengths(
    ...
    *,
    ...
    # The mapping needs only the exact backend tokenizer.  Loading
    # tokenizer.json directly avoids importing model/config/network helpers and
    # is byte-identical to AutoTokenizer.backend_tokenizer.encode_batch.
